...
public interface Config {
    ...
    static final String CREATE_CONVERSATION_TABLE = "CREATE TABLE CONVERSATION (ID INTEGER AUTOINCREMENT, EMISOR TEXT,REMITENTE TEXT)";

    static final String CREATE_MESSAGES_TABLE = "CREATE TABLE MESSAGES (ID_MENSAJE INTEGER AUTOINCREMENT, ID_CONVERSATION INTEGER, MESSAGE TEXT)";
