...
public interface Config {
    ...
    static final String CREATE_MESSAGES_TABLE = "CREATE TABLE MESSAGES (ID_MENSAJE INTEGER PRIMARY KEY AUTOINCREMENT, ID_CONVERSATION INTEGER, MESSAGE TEXT, FECHA TEXT)";
