...
public interface Config {
    ...
    static final String CREATE_CONVERSATION_TABLE = "CREATE TABLE CONVERSATION (ID INTEGER PRIMARY KEY AUTOINCREMENT, EMISOR TEXT,REMITENTE TEXT, MENSAJES_PENDIENTES INTEGER)";
